...
public class RobotMap {
    ...
    public static final int HATCH_PLACER_SOLENOID_MODULE = 0;
    public static final int HATCH_PLACER_SOLENOID_CHANNEL = 4;
    ...
    public static final int DRIVETRAIN_FRONT_RIGHT_ANGLE_MOTOR = 17;
    ...
    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_MOTOR = 99;
    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_ENCODER = 1;
    public static final int DRIVETRAIN_BACK_LEFT_DRIVE_MOTOR = 9;

    public static final int DRIVETRAIN_BACK_RIGHT_ANGLE_MOTOR = 16;
